...
namespace Purplepen
{
    ...
    partial void Ondot_idChanged();
		...
		public comment()
		{
			...
			this._dot = default(EntityRef<dot>);
			OnCreated();
		}
		...
		public int dot_id
		{
			...
			set
			{
				...
				{
					if (this._dot.HasLoadedOrAssignedValue)
					{
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="dot_comment", Storage="_dot", ThisKey="dot_id", OtherKey="dot_id", IsForeignKey=true)]
		public dot dot
		{
			get
			{
				return this._dot.Entity;
			}
			set
			{
				dot previousValue = this._dot.Entity;
				if (((previousValue != value) 
							|| (this._dot.HasLoadedOrAssignedValue == false)))
				{
					this.SendPropertyChanging();
					if ((previousValue != null))
					{
						this._dot.Entity = null;
						previousValue.comments.Remove(this);
					}
					this._dot.Entity = value;
					if ((value != null))
					{
    ...
    partial void Ondot_yChanged();
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="dot_comment", Storage="_comments", ThisKey="dot_id", OtherKey="dot_id")]
